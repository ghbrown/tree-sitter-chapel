...
enum {
  ...
  aux_sym_legal_identifier_chars_repeat1 = 43,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [aux_sym_legal_identifier_chars_repeat1] = "legal_identifier_chars_repeat1",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym_legal_identifier_chars_repeat1] = aux_sym_legal_identifier_chars_repeat1,
};
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym_legal_identifier_chars_repeat1] = {
    .visible = false,
    .named = false,
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [36] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(29),
  [39] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(29),
  ...
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inline_comment, 2),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_inline_comment, 2),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_legal_identifier_chars_repeat1, 2),
  [73] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_legal_identifier_chars_repeat1, 2), SHIFT_REPEAT(12),
  [76] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_legal_identifier_chars_repeat1, 2), SHIFT_REPEAT(19),
  ...
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 5),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_definition, 5),
  ...
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_letter_or_underscore, 1),
  [101] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [103] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier, 2),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_list, 2),
  ...
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_kind, 1),
  ...
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_expression, 1),
